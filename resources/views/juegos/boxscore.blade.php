            ...
            <div class="w-50">
                ...
                <div class="table-responsive">
                    <table class="table table-sm text-center">
                        ...
                        <tbody>
                            <tr class="">
                                <td scope="row">{{ $juego->equipoLocal->nombre }}</td>
                                @for ($i = 1; $i <= $entradas; $i++)
                            ...
                            <tr class="">
                                <td scope="row">{{ $juego->equipoVisitante->nombre }}</td>
                                @for ($i = 1; $i <= $entradas; $i++)
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 fw-bold d-flex flex-column">
                        <span
                            class="border border-1 border-dark m-0 p-1">{{ $carrerasLocal > $carrerasVisitante ? 'Ganador' : 'Perdedor' }}</span>
                        <span>{{ $lanzadorLocal->jugador->nombre }} {{ $lanzadorLocal->jugador->apellidos }}</span>
                        <span>Record</span>
                    </div>
                    <div class="flex-grow-1 fw-bold d-flex flex-column text-end">
                        <span
                            class="border border-1 border-dark m-0 p-1">{{ $carrerasLocal < $carrerasVisitante ? 'Ganador' : 'Perdedor' }}</span>
                        <span> <span>{{ $lanzadorVisitante->jugador->nombre }}
                                {{ $lanzadorVisitante->jugador->apellidos }}</span></span>
                        <span>Record</span>
                    </div>
                </div>
            </div>
