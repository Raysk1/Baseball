...
@section('content')
    <form action={{ route('AmpayersJuegoStore') }} method="post">
        ...
        <div class="d-flex justify-content-center">
            <form action = {{'AmpayersJuegoUpdate'}} method = "POST">
            ...
            <div class="row mb-3">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="idJuego" id="idJuego" required @readonly(true)>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="idAmpayer" class="form-label">ID Ampayer:</label>
                        <input type="text" name="idAmpayer" class="form-control" id="idAmpayer" required @readonly(true)>
                        </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="idCuerpo" class="form-label">ID Cuerpo:</label>
                        <input type="text" name="idCuerpo" class="form-control" id="idCuerpo" required @readonly(true)>
